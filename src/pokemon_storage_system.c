...
static void Task_PCMainMenu(u8 taskId)
{
    ...
    case STATE_LOAD:
        ...
        AddTextPrinterParameterized2(0, FONT_NORMAL, sMainMenuTexts[task->tSelectedOption].desc, TEXT_SKIP_DRAW, NULL, TEXT_COLOR_WHITE, TEXT_COLOR_TRANSPARENT, TEXT_COLOR_DARK_GRAY);
    ...
    case STATE_HANDLE_INPUT:
        ...
        case MENU_NOTHING_CHOSEN:
            ...
            if (task->tSelectedOption != task->tNextOption)
            {
                ...
                FillWindowPixelBuffer(0, PIXEL_FILL(11));
                AddTextPrinterParameterized2(0, FONT_NORMAL, sMainMenuTexts[task->tSelectedOption].desc, 0, NULL, TEXT_COLOR_WHITE, TEXT_COLOR_TRANSPARENT, TEXT_COLOR_DARK_GRAY);
            }
            break;
        case MENU_B_PRESSED:
        case OPTION_EXIT:
