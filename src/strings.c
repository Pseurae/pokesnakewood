...
const u8 gMenuText_Open[] = _("Open");
...
const u8 gText_GoBackPrevMenu[] = _("Go back to the previous menu.");
...
const u8 gText_ConfirmTossItems[] = _("Throw away {STR_VAR_2}\n{STR_VAR_1}(s)?");
...
const u8 gText_FontSize1[] = _("{FONT_NORMAL}");
