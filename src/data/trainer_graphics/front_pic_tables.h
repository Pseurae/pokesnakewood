const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_YOUNGSTER_ZOMBIE] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(YOUNGSTER_ZOMBIE, gTrainerFrontPic_Youngster, 0x800),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(YOUNGSTER_ZOMBIE, gTrainerPalette_YoungsterZombie),
};
