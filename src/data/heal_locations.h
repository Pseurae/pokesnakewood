...
{
    [HEAL_LOCATION_LITTLEROOT_TOWN - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 12, 11},
    [HEAL_LOCATION_UNUSED - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 12, 11},
