...
#define B_TXT_ATK_NAME_WITH_PREFIX_MON1 0x9
#define B_TXT_ATK_PARTNER_NAME 0xA
#define B_TXT_ATK_NAME_WITH_PREFIX 0xB
#define B_TXT_DEF_NAME_WITH_PREFIX 0xC
#define B_TXT_EFF_NAME_WITH_PREFIX 0xD // EFF = short for gEffectBank
#define B_TXT_ACTIVE_NAME_WITH_PREFIX 0xE
#define B_TXT_SCR_ACTIVE_NAME_WITH_PREFIX 0xF
#define B_TXT_CURRENT_MOVE 0x10
#define B_TXT_LAST_MOVE 0x11
#define B_TXT_LAST_ITEM 0x12
#define B_TXT_LAST_ABILITY 0x13
#define B_TXT_ATK_ABILITY 0x14
#define B_TXT_DEF_ABILITY 0x15
#define B_TXT_SCR_ACTIVE_ABILITY 0x16
